...
<ParamField body="bandwidth_amount" type="number">
  कितनी बैंडविड्थ किराये पर लेनी है। वैकल्पिक: एनर्जी और बैंडविड्थ एक ही इनवॉइस में जोड़े जा सकते हैं।
</ParamField>

<ParamField body="duration" type="string">
  बैंडविड्थ किराये की अवधि: `1h` या `1d`। एनर्जी हमेशा प्रति घंटा होती है।
</ParamField>
